...
export const BusinessImpactStatusArea: React.FC<BusinessImpactStatusAreaProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-xs border border-slate-200/90 overflow-hidden mb-6">
      ...
      <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-sky-50 text-[#002E6E] border border-sky-200 uppercase tracking-wider">
      ...
      <div className="p-5">
        {!businessImpact ? (
          <div className="text-center py-10 px-4 bg-slate-50/70 rounded-xl border border-dashed border-slate-200/90">
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
              {/* 1. Simulated ROI */}
              <div className="p-4 rounded-xl bg-gradient-to-br from-sky-50/80 to-blue-50/40 border border-sky-200/80 shadow-xs">
                <div className="flex items-center justify-between text-[#002E6E] mb-1">
                  <span className="text-[11px] font-bold uppercase tracking-wider text-[#002E6E]">
                    Simulated ROI
                  </span>
                  <Percent className="w-4 h-4 text-[#007EA7]" />
                </div>
                <div className="text-2xl font-black text-[#002E6E] font-mono">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-emerald-50/80 to-emerald-50/30 border border-emerald-200/80 shadow-xs">
                ...
                <p className="text-[11px] text-slate-600 mt-1 font-mono">
                  {formatCurrency(businessImpact.baseline_revenue)} → {formatCurrency(businessImpact.post_action_revenue)}
                </p>
              </div>

              {/* 3. Campaign Cost */}
              <div className="p-4 rounded-xl bg-gradient-to-br from-slate-50 to-slate-100/60 border border-slate-200/90 shadow-xs">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-amber-50/80 to-amber-50/30 border border-amber-200/80 shadow-xs">
                ...
                <p className="text-[11px] text-slate-600 mt-1 font-mono">
                  {businessImpact.baseline_evening_orders} → {businessImpact.post_action_evening_orders}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
              <div className="p-3.5 rounded-xl bg-slate-50/80 border border-slate-200/90 shadow-xs">
            ...
            <div className="p-4 rounded-xl bg-sky-50/60 border border-sky-200/80 flex items-start gap-3">
              <Info className="w-5 h-5 text-[#007EA7] shrink-0 mt-0.5" />
              <div className="text-xs text-slate-800 space-y-1">
                <div className="font-bold text-[#002E6E]">
